...
class ListaO {
   ...
   friend class Iterador; //mediante esta linea permitimos que la clase lista pueda acceder a las funciones miembro pivadas y protegidas de la clase iterador
   ...
   public:
      class Iterador { //clase iterador, el cual resulta ser un tipo de puntero a la lista, nos permite movernos por la misma y utilizar una serie de metodos para obtener informacion de la misma, solo que no puede modificar a la lista
         ...
         public:
            ...
            int getFrecuencia(); //obtiene la frecuencia de un elemento de una celda de la lista
            int getValor(); //obtiene el valor de una celda de la lista
            int operator==(Iterador &); // i==j 
            int operator!=(Iterador &); // i==j 
            int operator*(); // copia del elemento, solo que mediante este operador no se puede modificar los elementos de la lista, solo se retorna una copia
      ...
      ListaO & insertarOrdenado(int); //metodo insertar creado para insertar nuevos elementos en cualquier posicion de forma ordenada
